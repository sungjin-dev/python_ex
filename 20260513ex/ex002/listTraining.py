...
'''
이번에 만들 출석부 관리 시스템은 리스트를 이용해서 학급의 학생 명단을 관리하는 
프로그램으로, 시나리오에 따라 프로그래밍을 전개합니다. 
...
students.remove('박찬호')
print(f'students: {students}')
print(f'students counts : {len(students)}')

# #4
studentsForHelp = students[:3]      # 0 1 2
print(f'studentsForHelp: {studentsForHelp}')        

# #5
students.append('이병규')
students.sort()              # append는 마지막에 추가하는거니까 작업 후 분류하는게 좋음
print(f'students: {students}')
...
보관하고 있는 혈액형을 종류별로 몇 팩씩 보유하고 있는지 한눈에 보여주는
프로그램을 만들어봅시다
'''
LOOP_COUNT = 10
